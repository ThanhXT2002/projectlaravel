                ...
                <div id="accordion">
                    ...
                    @foreach (__('module.model') as $key => $val)
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title w-100">
                                    <a class="d-block w-100 font-weight-bold menu-module" data-model={{ $key }}
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="menu-wrapper">
                <div class="notification text-center mt-2 {{(is_array(old('menu')) && count(old('menu'))) ? 'none': ''}}">
                    ...
                    @foreach (old('menu')['name'] as $key => $val)
                        <div class="row mb-3 menu-item ">
                            ...
                            <div class="col-lg-1 text-center">
                                <a href="" class="delete-menu btn btn-info btn-sm">
