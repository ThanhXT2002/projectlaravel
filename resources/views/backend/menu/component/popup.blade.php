<div class="modal fade" id="createMenuCatalogue">
    <form action="" method="post" class="create-menu-catalogue">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-error alert-dismissible my-2"></div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name ="crate" value="create"
                        class="btn btn-sm btn-outline-success rounded-0">Lưu lại</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
