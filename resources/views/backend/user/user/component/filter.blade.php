    ...
    <div class="filter d-flex flex-wrap justify-content-between my-2">
        ...
        <div class="d-flex flex-wrap justify-content-between ml-2">
            ...
            <div class="pr-1 start-end">
                <a href="{{ route('user.create') }}" class="btn btn-danger btn-sm d-flex align-items-center rounded-0 " style="width:140px"><i class="fa fa-plus mr-1"></i>{{ __('messages.btnFilter') }}</a>
            </div>
        </div>
    </div>
</form>
