...
<div class="card rounded-0 shadow-lg">
    <div class="card-header">
        <h3 class="card-title text-uppercase  text-gray font-weight-600 pt-2">
            {{ __('messages.album.heading') }}
        </h3>
        <div class="card-tools upload-album">
            <a href="" class="upload-picture btn btn-sm btn-success rounded-0 "><strong>{{ __('messages.album.image') }}</strong></a>
        </div>
    </div><!-- /.card-header -->
    @php
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="click-to-upload">
                    ...
                    <div class="text-sm">{{ __('messages.album.notice') }}</div>
                </div>
                @endif
