            ...
            <div class="wrapper wrapper-content animated fadeInRight">
                ...
                <div class="row">
                    <div class="col-lg-9 connectedSortable ui-sortable mb-3">
                        @include('backend.layout.component.content', ['model' => ($productCatalogue) ?? null])
                        @include('backend.layout.component.album', ['model' => ($productCatalogue) ?? null])
                        @include('backend.layout.component.seo', ['model' => ($productCatalogue) ?? null])
                    </div>
